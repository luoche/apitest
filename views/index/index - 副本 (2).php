        ...
        <div class="container center-block">
           ...
           <!--导航-->
            <ul class="nav nav-tabs nav-justified" id="main-nav">
                <li role="presentation" class="active" data-id="create-api-type"><a href="javascript:void(0);">创建接口分类</a></li>
                <li role="presentation"><a href="#" data-id="create-api-param">创建接口参数</a></li>
            </ul>
            
            <!--创建接口分类-->
            
            <form class="form-horizontal " id="create-api-type" action="<?=$category['action_url'];?>" method="post">
            ...
            <!--创建接口参数-->
                <!--第一步-->
                <form action="<?=$BaseMessage['action_url'];?>" method="post" class="form-horizontal" id="create-api-param">
                <div class="creat-api-step-1 dn">
                    <div class="page-header">
                      <h1>创建接口参数</h1>
                    </div>
                <!--  -->
              ...
              <form action="<?=$BaseMessage['action_url'];?>" method="post" class="form-horizontal dn" id="create-api-param">
                  <table class="table table-bordered table-1"> 
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" name="PostParam_type[]" placeholder="类型"></td>
                        <td>
                ...
                <table class="table table-bordered table-2"> 
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" name="ReturnParam_type[]" placeholder="类型"></td>
                        <td>
                ...
                <table class="table table-bordered table-3"> 
                    ...
                    <tr>
                        <td><input type="text" class="form-control" id="" name="ErrorMesage_errorcode[]" placeholder="接口名称"></td>
                        <td><input type="text" class="form-control" id="" name="ErrorMesage_msg[]" placeholder="描述"></td>
                        <td><input type="text" class="form-control" id="" name="ErrorMesage_solve_answer[]" placeholder="解决方案"></td>
                        <td><span class="remove-row">x</span></td>
                    </tr>
                </table>
                </form>
